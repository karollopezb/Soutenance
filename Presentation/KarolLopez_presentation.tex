...
\author[Karol Lina L\'opez]{\texorpdfstring{Karol Lina L\'opez\newline\href{mailto:karol-lina.lopez.1@ulaval.ca}{karol-lina.lopez.1@ulaval.ca}}{Karol Lina L\'opez}}
 ...
 \includegraphics[width=2.5cm]{fig/REPARTI.jpg}
 \end{minipage}\hfill%
 \begin{minipage}{0.33\textwidth}
 \includegraphics[width=2.5cm]{fig/ul_logo.pdf}
 \end{minipage}\hfill%
 \begin{minipage}{0.33\textwidth}
 \includegraphics[width=2.5cm]{fig/LVSN2.png}
 \end{minipage}
}
...
\begin{frame}
\frametitle{Effets de la recharge sur le réseau électrique}
\begin{center}
\begin{figure}
\includegraphics<1>[width=0.9\linewidth]{fig/smartgrid.png}
\caption*{\only<1>{\tiny{Source: Inauguration of the European Interoperability Centre for Electric Vehicles and Smart Grids}}}

\includegraphics<2>[width=0.6\linewidth]{fig/picos.pdf}
...
% \begin{center}
\begin{figure}
\includegraphics[width=\linewidth]{fig/figConcMap.pdf}
\end{figure}
...
\vspace{1mm}
\includegraphics[width=\linewidth]{fig/elNet.jpg}
\end{block}
}
\end{overlayarea}
\end{column}
...
\includegraphics[width=\linewidth]{fig/mb.jpg}
\end{block}
}
\end{overlayarea}
\end{column}
...
\includegraphics<1>[width=\linewidth]{fig/hydroquebec.jpg}
\end{center}
\end{frame}
...
\includegraphics<1 | handout:0>[width=\linewidth]{fig/meth01.pdf}
\includegraphics<2 | handout:0>[width=\linewidth]{fig/meth02.pdf}
\includegraphics<3 | handout:0>[width=\linewidth]{fig/meth03.pdf}
\includegraphics<4>[width=\linewidth]{fig/meth04.pdf}
\end{overlayarea}
\end{center}
\end{frame}
...
\includegraphics<1>[width=0.9\linewidth]{fig/obj01.pdf}
\includegraphics<2>[width=0.9\linewidth]{fig/obj02.pdf}
\includegraphics<3>[width=0.9\linewidth]{fig/obj03.pdf}
\end{center}
\end{frame}
...
\includegraphics[width=\linewidth]{fig/minFct.pdf}
\end{figure} 
 \end{center}
\end{frame}
...
\subsection{Processus de décision Marcovien}

\begin{frame}
\frametitle{Processus de décision Marcovien}
\begin{center}
\begin{itemize}
\item Les états :
...
\begin{frame}
\frametitle{Exemple illustrative de la programmation dynamique pour prise de décisions}
\begin{center}
\begin{figure}
% \includegraphics[width=\linewidth]{minFct.pdf}
\includegraphics[width=0.5\linewidth]{fig/figDinamycProgram04.pdf}
\end{figure} 
 \end{center}
\end{frame}
...
\begin{figure}
% \includegraphics[width=\linewidth]{minFct.pdf}
\includegraphics[width=0.4\linewidth]{fig/figresDeltaWithoutGasBWcolor02.pdf}
\end{figure} 
 \end{center}
\end{frame}
...
\toprule
\multirow{3}{*}{\B{EV}} & \multicolumn{7}{c}{\B{Summer}} & & \multicolumn{7}{c}{\B{Winter}} \\
& \B{GAS} & \multicolumn{2}{c}{\B{DP}} & \multicolumn{2}{c}{\B{AC}} & \multicolumn{2}{c}{\B{RD}} & & 
\B{GAS} & \multicolumn{2}{c}{\B{DP}} & \multicolumn{2}{c}{\B{AC}} & \multicolumn{2}{c}{\B{RD}} \\
\cmidrule(lr){3-4} \cmidrule(lr){5-6} \cmidrule(lr){7-8} \cmidrule(lr){11-12} \cmidrule(lr){13-14} \cmidrule(lr){15-16}
{} & \B{\$} & \B{\$} & \B{\%} & \B{\$} & \B{\%} & \B{\$} & \B{\%} & {} &
 \B{\$} & \B{\$} & \B{\%} & \B{\$} & \B{\%} & \B{\$} & \B{\%} \\
\midrule 
...
\B{Mean} & \B{120.8} & \B{\s21.5} & \B{88} & \B{\s62.6} & \B{58} & \B{\s67.5} & \B{57} &  & \B{\s62.1} & \B{\s9.6} & \B{87} & \B{\s31.7} & \B{52} & \B{\s33.9} & \B{50} \\
\B{Median} & \B{\s93.0} & \B{\s3.3} & \B{96} & \B{\s24.7} & \B{68} & \B{\s23.9} & \B{70} &  & \B{\s58.8} & \B{\s6.4} & \B{88} & \B{\s24.6} & \B{56} & \B{\s25.2} & \B{54} \\
\bottomrule    
\end{tabular}
}
% \end{center}
...
\begin{frame}
\frametitle{Analyses univariées des données - Corrélation et ACP} 
\end{frame}
...
\toprule
{} & \textbf{Temperature} & \textbf{Energy used} & \textbf{Gasoline price} & \textbf{HOD} & \textbf{HOEP} \\
\midrule
\textbf{Temperature}   	& \x1.00&0.02	&\B{0.81}	&$-$0.02	&0.15	\\
\textbf{Energy used}    & 	&1.00	&0.02	&\x0.06		&0.06	\\
\textbf{Gasoline price} & 	&	&1.00	&$-$0.00	&0.17	\\
\textbf{HOD}            & 	& 	&	&\x1.00		&0.71	\\
\textbf{HOEP}           & 	&	&	&		&1.00	\\
\bottomrule
\end{tabular}
}
...
\midrule
\textbf{Temperature}   &0.57&$-$0.41&$-$0.01&$-$0.06&\x0.71\\
\textbf{Energy used}    &0.08&\x0.08&\x0.99&\x0.01&\x0.00\\
\textbf{Gasoline price} &0.58&$-$0.40&$-$0.02&$-$0.10&$-$0.71\\
...
\begin{itemize}
\item HOEP ($\ve{x}^1$), HOD ($\ve{x}^2$), and  air temperature ($\ve{x}^3$) with 101 lags.
\item Energy consumed ($\ve{x}^4$) with 199 lags.
\item Scalar variables (converted into real values when necessary and normalized in the range $[0,1]$):
\begin{itemize}
\item $w_1:$ weekdays;
\item $w_2:$ hour;
\item $w_3: C_\mathit{el}(t-1)-C_\mathit{el}(t)$ is the difference in electricity price;
\item $w_4: C_\mathit{el}(t)$ is the electricity price [\$/kWh] at time $t$;
\item $w_5: C_\mathit{fuel}(t)$ is the gasoline price [\$/l] at time $t$;
\item $w_6: dis(t)$ is the distance traveled [km] at time $t$.
\end{itemize}
\end{itemize}

\pause
... et l'état de charge du véhicule ainsi que les optimal décisions obtenues avec la programmation dynamique.
...
\begin{figure}
\begin{center}
% \includegraphics[width=0.7\textwidth]{fig/figPCAvarExplained.pdf}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{fig/strat.pdf}
\end{center}
\end{figure}
\end{frame}
% 
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{fig/Diff_ANN_Inp_space_year_2003.pdf}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{fig/Diff_SVR_Inp_state_year_2003.pdf}
\end{center}
\end{figure}
\end{frame}
% 
...
\begin{center}
\begin{overlayarea}{\linewidth}{2.8in}
\includegraphics<1 | handout:0>[width=\linewidth]{fig/resultats01.pdf}
\includegraphics<2 | handout:0>[width=\linewidth]{fig/resultats02.pdf}
\includegraphics<3>[width=\linewidth]{fig/resultats03.pdf}
\end{overlayarea}
\end{center}
\end{frame}
...
{\usebackgroundtemplate{%
  \parbox[c][\paperheight][c]{\paperwidth}{\centering\includegraphics[width=\linewidth]{fig/quest.jpg}}} 
