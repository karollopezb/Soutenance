...
% \begin{center}
\begin{figure}
\includegraphics[width=\linewidth]{figConcMap.pdf}
\end{figure}
...
\includegraphics[width=\linewidth]{PriceDist_201.pdf}
\end{figure} 
 \end{center}
\end{frame}
...
\begin{figure}
% \includegraphics[width=\linewidth]{minFct.pdf}
\includegraphics[width=0.7\linewidth]{figDinamycProgram04.pdf}
\end{figure} 
 \end{center}
\end{frame}
...
\begin{figure}
% \includegraphics[width=\linewidth]{minFct.pdf}
\includegraphics[angle=90,width=0.9\linewidth]{figresDeltaWithoutGasBWcolor02-Sout.pdf}
\end{figure} 
 \end{center}
\end{frame}
...
\B{Mean} &  \B{\s62.1} & \B{\s9.6} & \B{87} & \B{\s31.7} & \B{52} & \B{\s33.9} & \B{50} \\
\B{Median} &  \B{\s58.8} & \B{\s6.4} & \B{88} & \B{\s24.6} & \B{56} & \B{\s25.2} & \B{54} \\
\bottomrule    
\end{tabular}
}
...
% 263 & \s32.0 & \s2.3 & 93 & \s\s9.6 & 70 & \s\s8.3 & 74 & & \s52.8 & \s7.2 & 86 & \s23.0 & 56 & \s24.7 & 53 \\
% 265 & \s57.7 & \s1.6 & 97 & \s17.3 & 70 & \s15.7 & 73 & & \s23.8 & \s2.4 & 90 & \s10.9 & 54 & \s11.1 & 53 \\
\B{Mean} & \B{120.8} & \B{\s21.5} & \B{88} & \B{\s62.6} & \B{58} & \B{\s67.5} & \B{57} &   \\
\B{Median} & \B{\s93.0} & \B{\s3.3} & \B{96} & \B{\s24.7} & \B{68} & \B{\s23.9} & \B{70} &  \\
\bottomrule    
\end{tabular}
}
...
\begin{overlayarea}{\linewidth}{2.8in}
\begin{center} \includegraphics<1 | handout:0>[width=0.78\linewidth]{figUnivAnl.pdf} \end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{figPCAvarExplained.pdf}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\textwidth]{figStratEstim_222_summer3.pdf}
\end{center}
\end{figure}
\end{frame}
% 
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{Diff_ANN_Inp_space_year_2003.pdf}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{Diff_SVR_Inp_state_year_2003.pdf}
\end{center}
\end{figure}
\end{frame}
% 
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{artMeth2Compact-2.pdf}
\end{center}
\end{figure}
\end{frame}
...
\begin{itemize}
\item Threshold-Based Rule
\item k-Nearest Neighbors
\item Shallow Neural Network with Stratified Data
...
\begin{frame}
\frametitle{Threshold-Based Rule} 
\begin{figure}
\begin{center}
\includegraphics[width=0.9\textwidth]{figtbr.pdf}
\end{center}
\end{figure}
\end{frame}
% 
...
\begin{figure}
\begin{center}
\includegraphics[width=0.9\textwidth]{figCostML.pdf}
\end{center}
\end{figure}
\end{frame}
