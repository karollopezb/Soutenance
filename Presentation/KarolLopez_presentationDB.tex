...
\setbeamertemplate {footline}{\quad\hfill\insertframenumber/\inserttotalframenumber}
...
% \end{minipage}
 \begin{minipage}{0.33\textwidth}
 \centering \includegraphics[width=2.5cm]{REPARTI.jpg}
 \end{minipage}%
 \begin{minipage}{0.33\textwidth}
 \centering \includegraphics[width=2.5cm]{ul_logo.pdf}
 \end{minipage}%
 \begin{minipage}{0.33\textwidth}
 \centering \includegraphics[width=2.5cm]{LVSN2.png}
 \end{minipage}
 }
...
\includegraphics<1 | handout:0>[width=0.9\linewidth]{newFigs/figGralMeth01.pdf}
\includegraphics<2 | handout:0>[width=0.9\linewidth]{newFigs/figGralMeth02.pdf}
\includegraphics<3>[width=0.9\linewidth]{newFigs/figGralMeth03.pdf}
\end{overlayarea}
\end{center}
\end{frame}
...
\begin{overlayarea}{\linewidth}{2.8in}
\begin{center} 
\includegraphics<1 | handout:0>[width=0.95\linewidth]{newFigs/figUnivAnlFr1.pdf} 
\includegraphics<2 | handout:0>[width=0.95\linewidth]{newFigs/figUnivAnlFr2.pdf}
\includegraphics<3>[width=0.95\linewidth]{newFigs/figUnivAnlFr3.pdf}
\end{center}
\end{overlayarea}
\end{frame}
...
\toprule
{} & \textbf{Temp.} & \textbf{Énergie} & \textbf{\$ Essence} & \textbf{HOD} & \textbf{HOEP} \\
\midrule
\textbf{Temp.}   	& \x1.00&0.02	&\B{0.81}	&$-$0.02	&0.15	\\
\textbf{Énergie}    & 	&1.00	&0.02	&\x0.06		&0.06	\\
\textbf{\$ Essence} & 	&	&1.00	&$-$0.00	&0.17	\\
...
\toprule
{} & \textbf{1$^{\mbox{er}}$} & \textbf{2$^{\mbox{\`eme}}$} & 
\textbf{3$^{\mbox{\`eme}}$} & \textbf{4$^{\mbox{\`eme}}$} & \textbf{5$^{\mbox{\`eme}}$} \\
\midrule
\textbf{Temp}   &0.57&$-$0.41&$-$0.01&$-$0.06&\x0.71\\
\textbf{Énergie}    &0.08&\x0.08&\x0.99&\x0.01&\x0.00\\
\textbf{\$ Essence} &0.58&$-$0.40&$-$0.02&$-$0.10&$-$0.71\\
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{newFigs/figPCAvarExplainedFr2.png}
\end{center}
\end{figure}
\end{frame}
...
%                 &   \hangindent=0.6cm \bibentry{lopez2018b}.\\
% \end{tabular}
\bibentry{lopez2018b}
% 
% \begin{description}[style=nextline,leftmargin=0pt] 
%  \item[Article de conférence]  \bibentry{lopez2018b}
% \end{description}
\end{frame}
...
% 
% \begin{description}[style=nextline,leftmargin=0pt] 
%  \item[Article de journal]  \bibentry{lopez2015}
% \end{description}
\bibentry{lopez2015}
\end{frame}
...
\bibentry{lopez2018}
% \begin{description}[style=nextline,leftmargin=0pt] 
% \item[Article de journal]  \bibentry{lopez2018}
% \end{description}
\end{frame}
